...
export const UI: Record<Lang, Record<string, string>> = {
  TR: {
    ...
    security: "Güvenlik",
    securityContactCta: "Güvenlik bulgusu mu buldun? Sadece iletişim formu üzerinden bildir.",
    ...
    apiKeyHidden: "Anahtarın kayıtlı ama güvenlik gereği bir daha gösterilmiyor (sadece hash'i saklanıyor). Kaybettiysen yeniden üret.",
  ...
  EN: {
    ...
    security: "Security",
    securityContactCta: "Found a security issue? Report it only through the contact form.",
    ...
    apiKeyHidden: "You have a key, but for security it is never shown again (only its hash is stored). Regenerate it if you lost it.",
...
export const FEATURES: Record<Lang, Feature[]> = {
  TR: [
    ...
    { icon: "🔔", accent: "var(--accent2)", title: "Bülten", desc: "Seçtiğin kaynak ve konulara göre günlük özet e-postası al, ya da anahtar kelime eşleştiğinde anında haberdar ol.", href: "/account#newsletter" },
    { icon: "⇩", accent: "var(--neu)",     title: "Ham Veri Export", desc: "Tüm haber verini CSV veya JSON olarak indir — başlık, içerik, duygu analizi, entity ve kalite skorları dahil.", badge: "KURUMSAL", href: "/account#export" },
  ...
  EN: [
    ...
    { icon: "🔔", accent: "var(--accent2)", title: "Newsletter", desc: "Get a daily digest email for the sources and topics you pick, or an instant alert the moment a keyword matches.", href: "/account#newsletter" },
    { icon: "⇩", accent: "var(--neu)",     title: "Raw Data Export", desc: "Download all your news data as CSV or JSON — title, content, sentiment, entities and quality scores included.", badge: "ENTERPRISE", href: "/account#export" },
