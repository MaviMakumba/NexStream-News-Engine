...
- **Test sayısı:** 837 test, hepsi yeşil (backend, 27 Ağu 2026 — RAG kanıt paketine content eklenmesi + test süiti SMTP/Resend sızıntısı kapatılması için +4); frontend `tsc --noEmit` + `next build` temiz.
