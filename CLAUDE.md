...
- **Versiyon:** v2.7 🚀 **CANLIDA: https://nexstreamnewsengine.duckdns.org** (son deploy: 31 Ağustos 2026, PR #80 dahil — **deploy artık tam otomatik**, main'e her merge'de GitHub Actions kendi kendine SSM'e bağlanıp redeploy ediyor, bkz. "Branch" notu aşağıda). İlk canlıya çıkış: 29 Temmuz 2026.
- **Test sayısı:** 881 test, hepsi yeşil (backend, 31 Ağu 2026 — PR #80 için +27); frontend `tsc --noEmit` + `next build` temiz.
